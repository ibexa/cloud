...
final class UpsunEnvVarLoaderTest extends TestCase
{
    ...
    public function providerForTestLoadEnvVars(): iterable
    {
        ...
        yield 'valkey cache with session fallback' => [
            [
                'replica_db' => [
                    [
                        'host' => 'database.internal',
                ...
                'valkeycache' => [
                    [
                        ...
                        'hostname' => 'valkey.service._.eu-4.platformsh.site',
                        'cluster' => 'some_cluster',
                        'service' => 'valkeycache',
                        'rel' => 'valkey',
                        'scheme' => 'valkey',
            ...
            [
                ...
                'REPLICA_DB_DRIVER' => 'mysql',
                'REPLICA_DB_SERVER' => 'mysql://database.internal:3306',
                'VALKEYCACHE_URL' => 'redis://valkeycache.internal:6379',
                'VALKEYCACHE_HOST' => 'valkeycache.internal',
                'VALKEYCACHE_PORT' => '6379',
                'VALKEYCACHE_SCHEME' => 'redis',
                'CACHE_POOL' => 'cache.redis',
                'CACHE_DSN' => 'valkeycache.internal:6379?retry_interval=3',
                'SESSION_HANDLER_ID' => NativeSessionHandler::class,
                'SESSION_SAVE_PATH' => 'valkeycache.internal:6379',
                'HTTPCACHE_VARNISH_INVALIDATE_TOKEN' => 'project_entropy',
                'APP_SECRET' => 'project_entropy',
            ],
            $serverValues,
